<script>
    ...
    export let titre, text, styles, borderBgColor, h1 = false
</script>
...
{/if}
{#if text !== null}
<div class="md:text-center md:mx-auto text-gray-600 pb-5 md:pb-8 md:w-2/3">{@html PrismicDom.RichText.asHtml(text)}</div>
{/if}