...
<section class="container pb-20 md:pb-24">
	<div class="font-light sm:w-1/2">{@html PrismicDOM.RichText.asHtml(fondatrices.data.description_1)}</div>
	...
	<div class="flex flex-col lg:flex-row justify-between lg:space-x-20">
		...
		<div class="font-light sm:w-1/2 lg:text-right">{@html PrismicDOM.RichText.asHtml(fondatrices.data.description_2)}</div>
	</div>
</section>
{#each body as slice}
